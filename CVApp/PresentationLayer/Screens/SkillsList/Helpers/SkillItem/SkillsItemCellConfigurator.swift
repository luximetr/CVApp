//
//  SkillItemCellConfigurator.swift
//  CVApp
//
...
class SkillItemCellConfigurator: ContainerTableCellConfigurator<SkillItemView> {
  
  // MARK: - Cell data
  
  override var cellId: String { return "skillsItemCell" }
