//
//  TitleValueItemCellConfigurator.swift
//  CVApp
//
...
class TitleValueItemCellConfigurator: ContainerTableCellConfigurator<TitleValueItemView> {
  
  // MARK: - Cell data
  
  override var cellId: String { return "titleValueCell" }
